...
private:
	...
	glm::mat4 m_projMatrix, m_viewMatrix, VP, offset;
...
public:
	...
	glm::vec3 positionModifer = glm::vec3(5, 10, 30);
	void Recalculate();
	...
	void ModifyPositionOrtho();
	void ModifyPositionPerp();
	void DifferentCameraView();
	void tester();
};
